    ...
    <footer className="bg-gray-950 text-gray-500 py-8 sm:py-10">
        <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex justify-center space-x-6 my-4">
                 <a href="mailto:contact@yourbrand.com" aria-label="Email us at contact@yourbrand.com" className="hover:text-amber-500 transition-colors transform hover:scale-110"><HiOutlineMail className="w-7 h-7" /></a>
            ...
            <p className="mt-4">&copy; {new Date().getFullYear()} YourBrand Community. All Rights Reserved.</p>
